...
class ResNet(nn.Module) :
    def __init__(self, block, num_block, num_classes, num_channel):
        super(ResNet, self).__init__()

        self.in_channels = 64

        self.conv1 = nn.Sequential(
            nn.Conv2d(num_channel, 64, kernel_size=(3, 3), padding=(1, 1), bias=False),
            nn.BatchNorm2d(64),
            nn.ReLU()
        )
...
def resnet34(num_classes, num_channel) :
    ...
    """
    return ResNet(BasicBlock, [2, 4, 6, 3], num_classes, num_channel)

def resnet50(num_classes, num_channel) :
    """ return a ResNet 50 object
    """
    return ResNet(BottleNeck, [2, 4, 6, 3], num_classes, num_channel)
